...
export function pilotPrompt(goal, jobId, renderPrompt, projectNotes, cli = 'elowen', models, parallelism) {
...
export function makePilot(deps) {
    ...
    return async (job, projectPath) => {
        ...
        const renderPrompt = (name, vars) => deps.prompts.render(name, vars, job.createdBy);
