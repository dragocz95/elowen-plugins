...
export const MISSIONS_WITHOUT_TASKS = 'missions are unavailable: they are built on task tracking, whose plugin is disabled';
...
export function gateRoutesOnTaskDomain(ctx, available) {
    const registerApiRoute = (route) => {
