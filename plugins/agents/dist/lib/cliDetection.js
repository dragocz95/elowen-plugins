...
async function checkTool(name, bin, versionArg) {
    const result = { name, installed: false, functional: false, version: null, error: null };
    try {
...
export async function detectClis(context) {
