...
function detectTrust(output) {
    if (!/Yes, I trust this folder/i.test(output))
        return null;
    return {
...
function detectPermission(output) {
    if (!/Do you want to proceed\?/i.test(output))
        return null;
    return {
...
function detectQuestion(output) {
...
export function detectClaude(output) {
