import type { PluginApiRequest, PluginHttpResponse } from 'elowen/dist/plugins/api.js';
...
export const agentForbidden = (auth: ApiAuth, allowed: boolean): boolean =>
  auth.tokenScope === 'agent' && !allowed;
