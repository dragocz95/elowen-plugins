    ...
    ((e, t) => {
      ...
      function i(m3) {
        ...
        U2(m3.step) && (t = m3.step, m3.step = function(e2) {
          ...
          return m3.preview && m3.header && r3.preview++, n2 = e2, s2 = new E(r3), p2 = s2.parse(n2, t2, i3), _4(), f3 ? { meta: { paused: true } } : p2 || { meta: { paused: false } };
      ...
      function E(C4) {
        var S3 = (C4 = C4 || {}).delimiter, O = C4.newline, x2 = C4.comments, I2 = C4.step, A2 = C4.preview, T2 = C4.fastMode, D2 = null, L2 = false, F2 = null == C4.quoteChar ? '"' : C4.quoteChar, z2 = F2;
        ...
        this.parse = function(i2, t, r2) {
          ...
          var n2 = i2.length, e = S3.length, s2 = O.length, a2 = x2.length, o2 = U2(I2), h3 = [], u2 = [], d2 = [], l5 = M2 = 0;
          if (!i2) return v3();
          ...
          for (var p2 = i2.indexOf(S3, M2), _4 = i2.indexOf(O, M2), g2 = new RegExp(q2(z2) + q2(F2), "g"), m3 = i2.indexOf(F2, M2); ; ) if (i2[M2] === F2) for (m3 = M2, M2++; ; ) {
            ...
            if (F2 === z2 && i2[m3 + 1] === z2) m3++;
              ...
              if (i2.substring(m3 + 1 + y2, m3 + 1 + y2 + s2) === O) {
                if (d2.push(i2.substring(M2, m3).replace(g2, F2)), b3(m3 + 1 + y2 + s2), p2 = i2.indexOf(S3, M2), m3 = i2.indexOf(F2, M2), o2 && (R2(), j2)) return v3();
            ...
            if (-1 === _4) break;
            if (d2.push(i2.substring(M2, _4)), b3(_4 + s2), o2 && (R2(), j2)) return v3();
            if (A2 && h3.length >= A2) return v3(true);
          }
          return E2();
          function k3(e2) {
          ...
          function E2(e2) {
            return r2 || (void 0 === e2 && (e2 = i2.substring(M2)), d2.push(e2), M2 = n2, k3(d2), o2 && R2()), v3();
          }
          function b3(e2) {
