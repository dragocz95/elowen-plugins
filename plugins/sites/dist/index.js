...
export function register(published) {
    ...
    ctx.registerHttpRoute({
        ...
        handler: createSiteHandler({
            ...
            executePhp: (site, release, req, rest, viewer, siteRoot) => executePhp({ ctx, siteDir }, site, release, req, rest, { userId: viewer.userId, name: viewer.userId === null ? null : people().get(viewer.userId)?.username ?? null }, (() => {
                const resolved = config();
