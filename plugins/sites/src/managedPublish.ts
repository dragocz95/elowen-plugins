...
/** Copy static output through Sandbox's bounded, versioned managed Project file transport. */
    ...
    for (const entry of walked.entries) {
      ...
      try {
        do {
          ...
          if (!Number.isSafeInteger(read.totalBytes) || read.totalBytes < 0 || read.totalBytes !== entry.size) {
