...
export type GatewayCertificateProbe = (hostname: string) => Promise<GatewayCertificateObservation>;
...
export const probeGatewayCertificate: GatewayCertificateProbe = (hostname) => new Promise((resolve) => {
  let settled = false;
