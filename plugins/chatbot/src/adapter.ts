...
export function conversationChannelId(chatbotUserId: number, visitorId: string): string {
...
export class ChatbotAdapter {
  readonly name = CHATBOT_PLATFORM;

  private ingress: ChatbotIngressHandler | null = null;
  private relayFn: ChatbotRelay | null = null;
...
export function relayEventFields(event: ChatbotRelayEvent): { type: string; delta?: string; sessionId?: string; messageId?: string } {
  return {
