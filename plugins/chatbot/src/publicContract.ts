...
export const ACTION_KINDS = ['read', 'focus', 'click', 'fill', 'select', 'scroll', 'request_submit'] as const;
...
const ACTION_RULE_REFUSALS = ['action_not_allowed', 'confirmation_unavailable'] as const;
export type ActionRuleRefusal = (typeof ACTION_RULE_REFUSALS)[number];
