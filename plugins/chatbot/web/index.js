...
function BotDetail({ bot, requiredTools, onChanged, unknownError }) {
  ...
  const [limits, setLimits] = (0, import_react4.useState)(() => limitDraftOf(bot.limits));
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "flex flex-col gap-5", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "rounded-xl border border-border bg-card p-4", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "text-sm font-semibold text-foreground", children: s.limitsTitle }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "mt-1 text-xs leading-relaxed text-muted-foreground", children: s.limitsHint }),
      read.missing.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "mt-2 text-xs text-destructive", role: "alert", children: s.limitsMissing.replace("{fields}", missingText) }) : null,
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "mt-3 grid gap-x-6 gap-y-3 sm:grid-cols-2", children: LIMIT_FIELDS.map((field) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(C.Field, { label: s[`limit_${field}`], children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
        C.Input,
        {
          inputMode: "numeric",
          value: limits[field],
      ...
      read.invalid.map((field) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "mt-2 text-xs text-destructive", role: "alert", children: s.limitsRange.replace("{min}", String(specOf(field).min)).replace("{max}", String(specOf(field).max)) }, field))
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "rounded-xl border border-border bg-card p-4", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "text-sm font-semibold text-foreground", children: s.sensitiveTitle }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "mt-1 text-xs leading-relaxed text-muted-foreground", children: s.sensitiveBody })
    ] }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "flex flex-wrap items-center gap-3", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(C.Button, { variant: "accent", icon: dirty ? Save : Check, disabled: pending || !dirty || saveBlocked, onClick: () => void save(null), children: pending ? s.saveSaving : s.saveAction }),
