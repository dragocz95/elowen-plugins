/** Normalize the ordered Discord role-policy list at the runtime boundary.
...
/** Apply manifest defaults to malformed scalar values before the adapter sees direct API writes. */
