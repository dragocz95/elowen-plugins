 ...
 *
 *  Registers the work domain's three pages (task register, kanban board and timeline) on the host's
 *  plugin-UI runtime. The plugin already owns their tables, API routes and control-plane tools;
