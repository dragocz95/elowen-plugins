...
Semantic search and indexing for accessible repositories, using the configured embedding model.

## Install

Install **codebase** from **Settings → Plugins → Available**, then enable it.
