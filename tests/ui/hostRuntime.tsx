...
export function ensurePluginUiRuntime(): void {
  ...
  host.ElowenUiRuntime = {
    ...
    components: {
      ...
      // while the link mutation is in flight, and a stub that ignored the prop would let a suite drive a
      // control production had already locked.
      SelectMenu: C.SelectMenu,
