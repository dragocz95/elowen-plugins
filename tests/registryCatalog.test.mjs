...
const EXPECTED_CAPABILITIES = {
  ...
  // keeps no second copy of that decision; `elowen-cli` mints the acting account's own credential for the
  // retention deletion path. `network` was added when the panel's avatar started travelling over the
